...
const Hero = () => (
    <section id="home" className="md:grid md:grid-cols-2 md:gap-2 md:flex-row h-screen md:h-[70vh] lg:h-[50vh]">    
        <div className="h-1/2 bg-main md:h-full md:col-span-1">
        ...
        <div className="h-1/2 object-cover md:col-span-1 md:h-full ">
